 <div class="sidebar-menu">
    <header class="logo">
        <a href="#" class="sidebar-icon"> <span class="fa fa-bars"></span> </a> <a href="dashboard.php"> <span id="logo"> <h1>Softnet</h1></span> 
...
{               ?> -->
    ...
    <div class="menu">
        <ul id="menu" >
            ...
            <li id="menu-academico" ><a href="#"><i class="fa fa-user"></i> <span> My Account</span> <span class="fa fa-angle-right" style="float: right"></span></a>
                <ul id="menu-academico-sub" >
                    <li id="menu-academico-avaliacoes" ><a href="admin-profile.php"> Profile</a></li>
                    <li id="menu-academico-boletim" ><a href="change-password.php">Change Password</a></li>
            ...
            <li><a href="manage-client.php"><i class="fa fa-table"></i> <span>Customers List</span></a></li>
            <li><a href="add-client.php"><i class="fa fa-user"></i> <span>Add Customers</span></a></li>
